      ...
      <div className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Elite training for serious lifters with years of experience.
          </p>
          <button className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold transition">
            Log In to Access
          </button>
        </div>
      </div>
