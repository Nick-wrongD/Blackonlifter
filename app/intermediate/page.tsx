      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800/50 px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/choose"
              className="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-semibold text-sm transition"
            >
              + CHANGE LEVELS
            </Link>
          </div>
      ...
      <div className="pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Sport science training for explosive power and structural strength.
          </p>
          <button className="px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-bold transition">
            Log In to Access
          </button>
        </div>
      </div>
